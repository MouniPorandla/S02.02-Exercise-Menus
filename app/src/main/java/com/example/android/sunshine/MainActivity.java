...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menulist)
    {
        ...
        inflater.inflate(R.menu.forecast,menulist);
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem clicks)
    {
        int valueofid=clicks.getItemId();
        if(valueofid!=R.id.action_refresh){

            return onOptionsItemSelected(clicks);
        }else
        {
